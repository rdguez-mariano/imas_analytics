...
void draw_line(double *igray, int a0, int b0, int a1, int b1, double value, int width, int height)
{
...
void draw_square(float *igray, int a0, int b0, int w0, int h0, float value, int width, int height)
{
        ...
        draw_line((double*)igray,a0,b0,a0+w0,b0,(double)value,width,height);
        draw_line((double*)igray,a0,b0,a0,b0+h0,(double)value,width,height);
        draw_line((double*)igray,a0+w0,b0,a0+w0,b0+h0,(double)value,width,height);
        draw_line((double*)igray,a0,b0+h0,a0+w0,b0+h0,(double)value,width,height);
