    ...
    if ~OPENCV
        if (USAC)
            ...
            mex -v ...
                ...
                IMAS_matlab.cpp ...
                perform_IMAS.cpp IMAS_coverings.cpp ...
                compute_IMAS_keypoints.cpp compute_IMAS_matches.cpp ...
                local_descriptors_standalone.cpp ...
                ...
                mex_and_omp.cpp ...
                CXXFLAGS="\$CXXFLAGS -D _NO_OPENCV=1 -D _USAC=1 -fopenmp -fpermissive" LDFLAGS="\$LDFLAGS -fopenmp" ...
            ...
            mex -v ...
                ...
                libNumerics/numerics.cpp ...
                mex_and_omp.cpp ...
                CXXFLAGS="\$CXXFLAGS -D _NO_OPENCV=1 -fopenmp -fpermissive" LDFLAGS="\$LDFLAGS -fopenmp" ...
                CFLAGS="\$CFLAGS -fopenmp"
        end
